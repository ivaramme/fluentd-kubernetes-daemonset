...
ALL_IMAGES := \
	v1.7/debian-elasticsearch7:v1.7.3-debian-elasticsearch7-1.0,v1.7-debian-elasticsearch7-1,v1-debian-elasticsearch \
	v1.7/debian-elasticsearch6:v1.7.3-debian-elasticsearch6-1.0,v1.7-debian-elasticsearch6-1 \
	v1.7/debian-loganalytics:v1.7.3-debian-loganalytics-1.0,v1.7-debian-loganalytics-1 \
	v1.7/debian-loggly:v1.7.3-debian-loggly-1.0,v1.7-debian-loggly-1 \
	v1.7/debian-logentries:v1.7.3-debian-logentries-1.0,v1.7-debian-logentries-1 \
	v1.7/debian-cloudwatch:v1.7.3-debian-cloudwatch-1.0,v1.7-debian-cloudwatch-1 \
	v1.7/debian-stackdriver:v1.7.3-debian-stackdriver-1.0,v1.7-debian-stackdriver-1 \
	v1.7/debian-s3:v1.7.3-debian-s3-1.0,v1.7-debian-s3-1 \
	v1.7/debian-syslog:v1.7.3-debian-syslog-1.0,v1.7-debian-syslog-1 \
	v1.7/debian-forward:v1.7.3-debian-forward-1.0,v1.7-debian-forward-1 \
	v1.7/debian-gcs:v1.7.3-debian-gcs-1.0,v1.7-debian-gcs-1 \
	v1.7/debian-graylog:v1.7.3-debian-graylog-1.0,v1.7-debian-graylog-1 \
	v1.7/debian-papertrail:v1.7.3-debian-papertrail-1.0,v1.7-debian-papertrail-1 \
	v1.7/debian-logzio:v1.7.3-debian-logzio-1.0,v1.7-debian-logzio-1 \
	v1.7/debian-kafka:v1.7.3-debian-kafka-1.0,v1.7-debian-kafka-1 \
	v1.7/debian-kinesis:v1.7.3-debian-kinesis-1.0,v1.7-debian-kinesis-1
